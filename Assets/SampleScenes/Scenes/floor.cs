...
public class floor : MonoBehaviour
{
	...
	void Start()
    {
     Mypublic = GameObject.Find("mypublic");
	  iwalls = GameObject.Find("ifloors");
	  
	  Floormat = GameObject.Find("Floormat");
    ...
    void OnMouseDown()
    {      
		int x = Mypublic.GetComponent<mypublicscript>().floor;
		
	if(x == 1){
		  		  Mypublic.GetComponent<mypublicscript>().floor=2;
				    iwalls.GetComponent<UnityEngine.UI.Text>().text = "Floor 1";
					
					matfloor1 = Mypublic.GetComponent<mypublicscript>().matfloor1;
				foreach (Transform item in Floormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matfloor1;
        }
			...
			Mypublic.GetComponent<mypublicscript>().floor1.SetActive(true);
			...
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(false);
				 ...
				 Mypublic.GetComponent<mypublicscript>().floor=3;
				  iwalls.GetComponent<UnityEngine.UI.Text>().text = "Floor 2";
				  
				  matfloor2 = Mypublic.GetComponent<mypublicscript>().matfloor2;
				foreach (Transform item in Floormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matfloor2;
        }
		 ...
		 Mypublic.GetComponent<mypublicscript>().window1.SetActive(false);
			...
			Mypublic.GetComponent<mypublicscript>().floor2.SetActive(true);
			Mypublic.GetComponent<mypublicscript>().floor3.SetActive(false);
			...
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(false);
				 ...
				 Mypublic.GetComponent<mypublicscript>().floor=1;
				  iwalls.GetComponent<UnityEngine.UI.Text>().text = "Floor 3";
				  
				  matfloor3 = Mypublic.GetComponent<mypublicscript>().matfloor3;
				foreach (Transform item in Floormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matfloor3;
        }
		...
		Mypublic.GetComponent<mypublicscript>().wall1.SetActive(false);
			...
			Mypublic.GetComponent<mypublicscript>().floor1.SetActive(false);
			Mypublic.GetComponent<mypublicscript>().floor2.SetActive(false);
			Mypublic.GetComponent<mypublicscript>().floor3.SetActive(true);
