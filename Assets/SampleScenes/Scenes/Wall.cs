...
public class Wall : MonoBehaviour
{
 ...
 public  GameObject Mypublic;
		...
		void Start()
    {
	 ...
	 iwalls = GameObject.Find("iwalls");
	 
	 Wallmat = GameObject.Find("Wallmat");
	...
	if(x == 1){
				 ...
				 iwalls.GetComponent<UnityEngine.UI.Text>().text = "Wall 1";
				
				matwall1 = Mypublic.GetComponent<mypublicscript>().matwall1;
				foreach (Transform item in Wallmat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matwall1;
        }
			...
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(false);
				 ...
				 iwalls.GetComponent<UnityEngine.UI.Text>().text = "Wall 2";
				 
				 matwall2 = Mypublic.GetComponent<mypublicscript>().matwall2;
				foreach (Transform item in Wallmat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matwall2;
        }
			Debug.Log( x);
		 ...
		 Mypublic.GetComponent<mypublicscript>().window1.SetActive(false);
			...
			Debug.Log( x);
		iwalls.GetComponent<UnityEngine.UI.Text>().text = "Wall 3";
		
		matwall3 = Mypublic.GetComponent<mypublicscript>().matwall3;
				foreach (Transform item in Wallmat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matwall3;
        }
