...
public class door : MonoBehaviour
{
   public  GameObject Mypublic;
    ...
    void OnMouseDown()
    {      
		int x = Mypublic.GetComponent<mypublicscript>().door;
		
	if(x == 1){
		  		  Mypublic.GetComponent<mypublicscript>().door=2;
				   iwalls.GetComponent<UnityEngine.UI.Text>().text = "Door 1";
				   
				   matdoor1 = Mypublic.GetComponent<mypublicscript>().matdoor1;
				foreach (Transform item in Doormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matdoor1;
        }
			...
			Mypublic.GetComponent<mypublicscript>().door1.SetActive(true);
			Mypublic.GetComponent<mypublicscript>().door2.SetActive(false);
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(false);
 
    } 
	else if(x == 2){
				 Mypublic.GetComponent<mypublicscript>().door=3;
				 iwalls.GetComponent<UnityEngine.UI.Text>().text = "Door 2";
				 
				 matdoor2 = Mypublic.GetComponent<mypublicscript>().matdoor2;
				foreach (Transform item in Doormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matdoor2;
        }
		 ...
		 Mypublic.GetComponent<mypublicscript>().window1.SetActive(false);
			...
			Mypublic.GetComponent<mypublicscript>().door2.SetActive(true);
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(false);
		
	} else if(x == 3){
				 Mypublic.GetComponent<mypublicscript>().door=1;
				 iwalls.GetComponent<UnityEngine.UI.Text>().text = "Door 3";
				 
				 matdoor3 = Mypublic.GetComponent<mypublicscript>().matdoor3;
				foreach (Transform item in Doormat.transform)
        {
            item.GetComponent<MeshRenderer>().material = matdoor3;
        }
		...
		Mypublic.GetComponent<mypublicscript>().wall1.SetActive(false);
			...
			Mypublic.GetComponent<mypublicscript>().door1.SetActive(false);
			Mypublic.GetComponent<mypublicscript>().door2.SetActive(false);
			Mypublic.GetComponent<mypublicscript>().door3.SetActive(true);
	}
